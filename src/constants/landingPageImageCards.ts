export const ARABIC_TEAM_CARD_LIST = [
    {
    ...
    },
    {
        ...
        description:
            "arabic_team_description_CILRAP_Arabic_Translation_Team_Leader",
        isImageAvailable: true,
    },
];

export const ARABIC_TEAM_TEXT_CARD_LIST = [
    {
...
export const CORE_TEAM_CARD_LIST = [
    {
    ...
    },
    {
        ...
        description:
            "contributor_description_Chief_Editor_of_CLICC_and_Co-Director_of_Lexsitus",
    },
    {
    ...
    },
    {
        ...
        image: "rajan.jpg",
        description:
            "contributor_description_Media_Producer_and_Project Manager",
    },
    {
    ...
    },
    {
        ...
        image: "ralph.jpg",
        description:
            "contributor_description_Technical_developer_of_the_Case_Matrix",
    },
];

export const FRENCH_TEAM_CARD_LIST = [
    {
        name: "french_team_Antonio_Angotti",
        image: "antonio.jpg",
        description:
            "french_team_description_CILRAP_Fellow_and_Co-ordinator_of_Lexsitus",
    },
    {
...
export const PERSIAN_TEAM_CARD_LIST = [
    {
